    ...
    <div class="w-full">
        ...
        >
            ...
            <div class="flex flex-1 mt-8">
                ...
                >
                    <p>
                        Affordance refers to the relationship between an object
                        or system and the user's abilities to perceive and
                        interact with it. Affordances are the physical or
                        perceived properties of an object or system that suggest
                        how it can be used. The principle of affordance is
                        important in design because it helps users understand
                        how to interact with a system or object and what actions
                        are possible.
                    </p>
                    <p>
                        Affordances can be visual, such as a button that looks
                        clickable, or they can be physical, such as a lever that
                        can be pulled or pushed. They can also be perceived,
                        such as the affordance of a touchscreen that suggests it
                        can be interacted with by touching.
                    </p>
                    <p>
                        This temperature controller UI is designed in a way that
                        suggests how users can interact with it to set the
                        temperature. By incorporating clear physical and visual
                        affordances, matching the user's mental model, and
                        providing feedback, designers can create an interface
                        that is intuitive and easy to use, leading to a more
...
input {
    ...
    box-shadow: -24.75vmin 0 0 -19.5vmin #000c,
        ...
        -4.75vmin -24vmin 0 -19.1vmin #000c, 4.75vmin -24vmin 0 -19vmin #000c,
...
input::after {
    ...
    background: linear-gradient(
        ...
        linear-gradient(-45deg, transparent 50%, #111a 0 60%, transparent 0)
            90.875% 70.5% / 0.75vmin 4vmin,
        linear-gradient(#111a, #111a) 91% 72% / 0.4vmin 3vmin,
        linear-gradient(-45deg, transparent 50%, #111a 0 60%, transparent 0)
            92.875% 70.5% / 0.75vmin 4vmin,
